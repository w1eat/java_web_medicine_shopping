...
-- ----------------------------
BEGIN;
INSERT INTO `user` (`id`, `user_account`, `user_name`, `user_pwd`, `user_age`, `user_sex`, `user_email`, `user_tel`, `role_status`, `img_path`, `create_time`, `update_time`) VALUES (4, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 23, '男', '2900311336@qq.com', '15528436707', 1, '/uploads/1.jpg', '2022-05-03 15:55:41', '2022-05-03 15:56:15');
INSERT INTO `user` (`id`, `user_account`, `user_name`, `user_pwd`, `user_age`, `user_sex`, `user_email`, `user_tel`, `role_status`, `img_path`, `create_time`, `update_time`) VALUES (5, 'zhangsan', '张三', 'e10adc3949ba59abbe56e057f20f883e', 23, '女', 'abc@qq.com', '8888', 0, 'https://su-share.oss-cn-beijing.aliyuncs.com/5/5dc107dcd2db4cbd8ad561f4c1642886.png', '2022-05-03 16:15:53', '2022-05-03 16:17:12');
COMMIT;


DROP TABLE IF EXISTS `goods`;
CREATE TABLE `goods` (
                          `id` int(1) NOT NULL AUTO_INCREMENT COMMENT '购物车主键',
                          `user_name` varchar(255) DEFAULT NULL COMMENT '用户的真实名字',
                          `medicine_name` varchar(100) DEFAULT NULL COMMENT '药的名字',
                          `medicine_price` decimal(10,2) DEFAULT NULL COMMENT '药的价格',
                          `medicine_num` int(1) DEFAULT NULL COMMENT '药的数量',
                          `uuid` varchar(255) DEFAULT NULL COMMENT '创建时间',
                          PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;
